...
class MyThread(threading.Thread):
    ...
    def predict(self, frame):
        ...
        while detections[0, 1, j, 0] >= 0.2:
            ...
            box = [score] + (detections[0, 1, j, 1:] * scale).cpu().numpy().tolist()
...
def postImage():
    ...
    # plt.imshow(image)
    # bboxes = [[0.80586177110672,111.9474105834961,79.74383544921875,330.58477783203125,285.7025146484375], [0.80586177110672,111.9474105834961,89.74383544921875,350.58477783203125,295.7025146484375]]
    # plt.show()
    # pdb.set_trace()
...
if __name__ == '__main__':
    ...
    # app.run(host='compute-01', port=6670, threaded=True)
